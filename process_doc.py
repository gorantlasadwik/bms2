...
DST_FILE = r"C:\Users\sadwi\Downloads\CourtSetu_AI_SRS_Karl_Wiegers_Format.docx"
DST_FILE2 = r"C:\Users\sadwi\Downloads\Entity_Relationship_Diagram_Wiegers_Format.docx"


print("Loading original document...")
src_doc = docx.Document(SRC_FILE)

# Helper function to format tables like Karl Wiegers template
...
print("Creating new document using Karl E. Wiegers SRS Template...")
new_doc = docx.Document()

# Set standard page margins (1.0 in)
section_cover = new_doc.sections[0]
section_cover.top_margin = Inches(1.0)
section_cover.bottom_margin = Inches(1.0)
section_cover.left_margin = Inches(1.0)
section_cover.right_margin = Inches(1.0)
...
# Configure Heading 1
style_h1 = new_doc.styles['Heading 1']
...
# Configure Heading 2
style_h2 = new_doc.styles['Heading 2']
...
# Configure Heading 3
style_h3 = new_doc.styles['Heading 3']
...
# ==========================================
# PAGE 1: COVER PAGE (Wiegers Format)
# ==========================================

# Top thick horizontal bar
...
# Copyright notice at bottom of cover page
...
tab_stops = p_hdr.paragraph_format.tab_stops
...
# Formatted Table of Contents entries matching Karl Wiegers layout
toc_entries = [
...
p_rev_head.paragraph_format.space_before = Pt(18)
...
# ==========================================
# PAGE 3+: BODY SECTIONS (Wiegers Format)
# ==========================================
sec_body = new_doc.add_section(docx.enum.section.WD_SECTION.NEW_PAGE)
sec_body.header.is_linked_to_previous = False

# Header for body pages: Software Requirements Specification for CourtSetu AI ... Page X
hdr_body = sec_body.header
p_hb = hdr_body.paragraphs[0]
p_hb.alignment = WD_ALIGN_PARAGRAPH.LEFT
t_stops = p_hb.paragraph_format.tab_stops
t_stops.add_tab_stop(Inches(6.5), WD_TAB_ALIGNMENT.RIGHT)
...
print("Rebuilding body text with exact Karl Wiegers typography...")
...
print("SUCCESS! Document updated to match Karl E. Wiegers SRS template format!")
